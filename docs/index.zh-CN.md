...
一条命令 systemd 向导以及后续升级、回滚、修复和卸载见
[安装与长期管理](installation-management.zh-CN.md)。
...
| 安装与长期管理 | [English](installation-management.md) | [简体中文](installation-management.zh-CN.md) |
...
- [安装与长期管理](installation-management.zh-CN.md) — 交互向导与生命周期运维。
